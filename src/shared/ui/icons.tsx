export function LogoIcon({ className }: { className: string }) {
  return (
    <svg
      ...
      viewBox="0 0 58.44 50"
      fill="none"
    >
      <title>logo_50x50px</title>
      <rect
        fill="currentColor"
        x="4.34"
        y="3.66"
